import project2_ex1_1 from "../images/project2_ex1_1.png";
import project2_ex1_2 from "../images/project2_ex1_2.png";
import project2_ex2 from "../images/project2_ex2.gif";
...
export default function PageInner(props: { page: number }) {
        ...
        <div className="subScene first">
            <div className="examples">
                <video className="video" autoPlay={true} controls={true} muted={true}>
                    <source src={require("../videos/project1.mp4")} type="video/mp4" />
                </video>
...
function SecondScene() {
    return (
        <div className="subScene second">
            <div className="examples">
                <div className="codes">
                    <img src={project2_ex1_1} alt="halloween code" className="code one" />
                    <img src={project2_ex1_2} alt="halloween code" className="code two" />
                </div>
                <img src={project2_ex2} alt="halloween gif" className="gif"/>
            </div>
            <div className="info">
                <div className="basic">
        ...
        <div className="subScene third">
            <div className="examples">
                <div className="diagrams">
                    <img src={project3_1} alt="diagram" className="diagram one" />
                    <img src={project3_2} alt="diagram" className="diagram two" />
                </div>
                <img src={project3_3} alt="example code" className="example"/>
            </div>
            <div className="info">
                <div className="basic">
        ...
        <div className="subScene sixth">
            <div className="info one">
                <div className="basic">
                    ...
                    <p className="one">Individual: 2022.01 ~ 2022.01</p>
                </div>
                <div className="contents">
                    <div className="one">
                        <h3>Description</h3>
                        <p>This is a project that make this portfolio website. It is to show information about me such as experience and projects.</p>
                    </div>
                    <div className="two">
                        <h3>Skills</h3>
                        <p>React.js, SCSS</p>
                    </div>
                    <button><a href="https://github.com/chunga7879/portfolio">Github</a></button>
